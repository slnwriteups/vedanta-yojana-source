...
const UI_STRINGS = {
  ...
  bookAvailableForDownload: {
    ...
    te: "డౌన్‌లోడ్‌కు అందుబాటులో ఉంది",
  },
  bookDownloadButton: { en: "Download", ta: "பதிவிறக்கு", kn: "ಡೌನ್‌ಲೋಡ್ ಮಾಡಿ", hi: "डाउनलोड करें", te: "డౌన్‌లోడ్ చేయండి" },
  bookDownloading: { en: "Downloading…", ta: "பதிவிறக்குகிறது…", kn: "ಡೌನ್‌ಲೋಡ್ ಆಗುತ್ತಿದೆ…", hi: "डाउनलोड हो रहा है…", te: "డౌన్‌లోడ్ అవుతోంది…" },
  bookAvailableOffline: {
    en: "Available Offline",
    ta: "ஆஃப்லைனில் கிடைக்கும்",
    kn: "ಆಫ್‌ಲೈನ್‌ನಲ್ಲಿ ಲಭ್ಯವಿದೆ",
    hi: "ऑफ़लाइन उपलब्ध",
    te: "ఆఫ్‌లైన్‌లో అందుబాటులో ఉంది",
  },
  bookOpenButton: { en: "Open", ta: "திற", kn: "ತೆರೆಯಿರಿ", hi: "खोलें", te: "తెరవండి" },
  bookDownloadFailed: { en: "Download Failed", ta: "பதிவிறக்கம் தோல்வியடைந்தது", kn: "ಡೌನ್‌ಲೋಡ್ ವಿಫಲವಾಗಿದೆ", hi: "डाउनलोड विफल", te: "డౌన్‌లోడ్ విఫలమైంది" },
  bookTryAgain: { en: "Retry", ta: "மீண்டும் முயற்சிக்கவும்", kn: "ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ", hi: "पुनः प्रयास करें", te: "మళ్ళీ ప్రయత్నించండి" },
  bookRemoveOffline: {
    en: "Remove Offline Copy",
    ta: "ஆஃப்லைன் நகலை அகற்று",
    kn: "ಆಫ್‌ಲೈನ್ ಪ್ರತಿಯನ್ನು ತೆಗೆದುಹಾಕಿ",
    hi: "ऑफ़लाइन प्रति हटाएं",
    te: "ఆఫ్‌లైన్ ప్రతిని తొలగించండి",
  },
  bookDownloadToRead: {
    ...
    te: "ఆఫ్‌లైన్‌లో చదవడానికి ఈ పుస్తకాన్ని డౌన్‌లోడ్ చేసుకోండి.",
  },
  viewImageFullScreen: {
